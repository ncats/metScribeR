...
file.copy(from = system.file('extdata', package = 'metScribeR'), to = 'C:/user123/Downloads/metScribeR_extdata_folder', recursive=T)

library(metScribeR)

setwd('C:/user1/downloads/metScribeR_extdata_folder')
